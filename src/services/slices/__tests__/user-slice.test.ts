...
import userReducer, { loginUser, logout, registerUser, UserState } from "../user-slice"
...
describe('Register, Log in and out tesing', () => {
    test('Login test', () => {
        ...
        const nextState = userReducer(initialState, loginUser.fulfilled(
            {
    ...
    test('Logout test', () => {
        const spy = jest.spyOn(apiModule, 'logoutApi').mockResolvedValue({success: true});
